...
#   unique          NaN       NaN     NaN                        891     2     NaN     NaN     NaN       681     NaN          147        3 #for text data ans is there
#   top             NaN       NaN     NaN  Graham, Mr. George Edward  male     NaN     NaN     NaN  CA. 2343     NaN  C23 C25 C27        S # this is value repeated max times
#   freq            NaN       NaN     NaN                          1   577     NaN     NaN     NaN         7     NaN            4      644 #max no of times above value is repeated
...
print train.sample(5) #random 5 values
...
#4)The Embarked feature is missing 0.22% of its values,
...
df =  train[train["Sex"]=="female"].groupby("Survived").count()
...
#Now that we've filled in the missing values at least somewhat accurately, it is time to map each age group to a numerical value.
...
#Decided to use the Random Forest model for the testing data.
